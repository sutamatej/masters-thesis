...
approximation or heuristic needs to be done. That means a trade-off
has to be made. The approximation should be relatively precise and quick
to compute with reasonable memory footprint. The level of precision
is therefore application specific.

The main goal is to build tools which can perform static analysis.
