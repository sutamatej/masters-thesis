...
of static analysis. They are already checked by compiler. Thus, only
errors which lead to unexpected or undefined behavior are checked.
A typical example of detected errors are accessing items of an array out
of bounds, division by zero or software metrics. Depending on the
