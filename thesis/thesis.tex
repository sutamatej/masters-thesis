...
written in the \texttt{C} programming language.
...
In the \texttt{C} programming language strings are separated from the rest of
...
NUL~\ref{nullstring13-1}. Strings terminated by such character are usually
...
of pushdown automata called $\varepsilon$ bounded pushdown automata. This automata
...
\begin{lstlisting}
$ sudo apt-get install g++ cmake clang libreadline-dev libelf-dev llvm-dev libclang-dev
\end{lstlisting}
...
contain items \texttt{strinPrefix}, \texttt{stringSuffix} and
