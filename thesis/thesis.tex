...
four decades now and are likely to continue for a few more years.
Hardware gets more powerful and complex and software follows the same
pattern. \todo{the cost of complexity - more bugs, SW reliability}

There are many techniques that try to prevent software bugs,
