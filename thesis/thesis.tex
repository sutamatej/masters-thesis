...
\cite{Turing36-1}. Intuitivelly, the problem can be interpreted as:

\begin{quote}

Given a computer program and its input 

\end{quote}

Formally, the Halting problem is defined as \cite{Sipser06-1}:

\begin{displaymath}

A_{TM} = \{ \langle M, w \rangle |
  M \text{ is a TM and} M \text{ accepts} w \}
