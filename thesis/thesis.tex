...
analyzing the source code of the program. They are called dynamic and
static verification respectively. These activities are typically
...
unit testing or integration testing among others. On the other hand the
static verification usually includes source code inspection either
...
for programmer. Scalability is another issue -- the analysis must conform
to reasonable time and memory requirements for it to be actually useful.
