...
\node (top) at (0, 4) {$\top$};
\node (stopepuper) at (0, 3) {stopepuper};
\node (stopep) at (-1, 2) {stopep};
\node (stopuper) at (0, 2) {stopuper};
\node (stepuper) at (1, 2) {stepuper};
\node (stop) at (-1, 1) {stop};
\node (step) at (0, 1) {step};
\node (super) at (1, 1) {super};
